...
Once the server is running, open browser and navigate to `http://localhost:4200/`. The application will automatically reload whenever we modify any of the source files.
